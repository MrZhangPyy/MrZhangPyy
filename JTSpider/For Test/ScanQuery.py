...
def request_data(headers, page, pageSize, startTime, endTime, startRow):
    data = {"current": page,
            "size": pageSize,
    ...
    print("导出", page, "结束, 耗时：", exportEndTime - exportStartTime, "秒！")
    return page
...
if __name__ == '__main__':
    headers = {
        ...
        'authtoken': 'f2b67681dafc48f4a56f0969555cc6f5',
    ...
    for item in times:
        ...
        for page in range(max_page):
            obj = threadPool.submit(request_data, headers, page, pageSize, startTime, endTime, total + 2)
            obj_list.append(obj)
