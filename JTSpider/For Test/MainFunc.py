...
def data_wash(waybillNo_Pool):
    ...
    for i in range(count):
        pre_data = {"current": 1, "size": 1000, "startDates": "2022-07-13 00:00:00", "endDates": "2022-07-13 23:59:59",
                "scanType": "全部", "filterNo": "2", "sortName": "scanDate", "sortOrder": "desc",
                "bilNos": waybillNo_Pool[i_from:i_to], "queryTerminalDispatchCode": 0, "querySub": "",
        ...
        for pages in range(max_pages):
            data = {"current": 1, "size": 1000, "startDates": "2022-07-13 00:00:00", "endDates": "2022-07-13 23:59:59",
                    "scanType": "全部", "filterNo": "2", "sortName": "scanDate", "sortOrder": "desc",
                    "bilNos": waybillNo_Pool[i_from:i_to], "queryTerminalDispatchCode": 0, "querySub": "",
                    "reachAddressCodeList": [], "sendSites": [], "billType": 1, "countryId": "1"}
            ...
            billNoPoolTemp = pd.DataFrame(response["data"]["records"])
            billNoSum = pd.concat([billNoSum,billNoPoolTemp])
